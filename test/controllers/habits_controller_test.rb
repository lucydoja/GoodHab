...
class HabitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habit" do
    assert_difference('Habit.count') do
      post habits_url, params: { habit: { category: @habit.category, date: @habit.date, description: @habit.description, hours: @habit.hours, minutes: @habit.minutes } }
    end
  ...
  test "should update habit" do
    patch habit_url(@habit), params: { habit: { category: @habit.category, date: @habit.date, description: @habit.description, hours: @habit.hours, minutes: @habit.minutes } }
